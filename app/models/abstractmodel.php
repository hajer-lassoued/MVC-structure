...
class AbstractModel
{
    ...
    private function create()
    {
        ...
        if($stmt->execute()) {
            $this->{static::$primaryKey} = DatabaseHandler::factory()->lastInsertId(); // $primaryKey a static property of the class already declared on EmployeeModel and represent the key in db
            return true; 
        }
        return false;
    }
